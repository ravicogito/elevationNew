        ...
        <div class="col-md-6 col-md-offset-3 animated-panel zoomIn" style="animation-delay: 0.1s;">
            <div class="hpanel hblue">
                <div class="panel-body">
                    ...
                    ?>
                    <br/>
                    <form role="form" method="post" action="<?php echo base_url().'Event/addEvent/';?>" onsubmit="return Checkingform(this);" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<select name="photographer_name" id="photographer_id" class="form-control">
								...
								?>
								<option value="<?php echo $all_photographer->photographer_id; ?>"><?php echo $all_photographer->photographer_name; ?></option>
								<?php
								}
								} ?>
