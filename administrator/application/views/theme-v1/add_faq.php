  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <?php } ?>
          ...
          <form role="form" method="post" action="<?php echo base_url().'Faq/addFaq/';?>" onsubmit="return Checkingform(this);" enctype="multipart/form-data">
           <!-- text input -->
                <div class="form-group">
                  <label>FAQ Question</label>
                  <input type="text" class="form-control" id="ptitle" name="ptitle" placeholder="Enter ...">
                </div>
                <!-- text input end -->
            <div class="box box-info">
              <div class="box-header">
                <h3 class="box-title">FAQ Answer </h3>
                <!-- tools box -->
