...
$(document).ready(function(){
	$(".img_show").click(function(){
		...
		$("#image_decs_post").val("0");
			...
			$.ajax({
						url: _basePath+"guide/imageDetails/",
						type: 'POST',
						dataType: 'JSON',
						data:  { 
							'id': get_id 
	...
	function verify(){
		msg = "Are you absolutely sure that you want to delete this Image?";
...
<div class="content animate-panel">
    <div class="row">
    	<div class="panel-body">
    		<h3 style="padding: 15px 20px; background: #222d32; color:#fff;">Guide [<?=$event_data['event_name']?>] <span style="float: right;position: relative; color:#fff;"><a href="<?=$back_link?>" style="color: #fff; font-size: 16px; background: #008d4c; padding: 5px 30px; border-radius: 2px;">Back</a></span></h3> 
			...
			<div class="imgDisplay">
				<a data-toggle="modal" href="" id="<?php echo $img['media_id']; ?>" class="img_show" data-target="#myModal">
				<img src="<?=thumbcreate($imagePath, $img_path, '400', '400')?>" style="max-width: 100%;">
				</a>
				<!--<a style="text-align:center;" href="<?php echo base_url(); ?>guide/deleteImages/<?php //echo $img['media_id'].'_'.$event_id; ?>" onclick="return verify();"><img style="height: 24px; margin-top:5px;" src="<?php echo $front_url; ?>assets/images/delete_butt.png"></a>!-->
			</div>
				...
				<div class="modal-content">
				  ...
				  <div class="modal-body see_all_frm">
				   <form method="post" name="media_data">
					...
					<div class="col-md-6"><label>Media Price:</label> <input type="text" name="media_price" id="media_price" value="<?php //echo (!empty($img['media_price'])) ? $img['media_price'] : ''; ?>"></div>
					<div class="col-md-6"><label>Photo Resolution:</label> <input type="text" name="photo_resolution" id="photo_resolution" value="<?php  ?>"></div>
                    <div class="clearfix"></div>
					<div class="col-md-6"><label>Photo Size:</label> <input type="text" name="photo_size" id="photo_size" value=""></div>
					<div class="col-md-6"><label>Digital Format:</label> <input type="text" name="digital_format" id="digital_format" value=""></div>
                    <div class="clearfix"></div>
					<div class="col-md-6"><label>Photo Title:</label> <input type="text" name="photo_title" id="photo_title" value=""></div>
					<div class="col-md-6"><label>Photo Description:</label> <input type="text" name="photo_description" id="photo_description" value=""></div>
                    <div class="clearfix"></div>
			...
			<?php else: ?>
			<p>There Is no Images On This List</p>
			<?php endif; ?>
        </div>
    </div>
</div>
