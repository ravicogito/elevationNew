        ...
        <div class="col-md-6 col-md-offset-3 animated-panel zoomIn" style="animation-delay: 0.1s;">
            <div class="hpanel hblue">
                <div class="panel-body">
                    ...
                    <form role="form" method="post" action="<?php echo base_url().'Options/addOptionMeta/';?>" onsubmit ="return Checkingform(this);" enctype="multipart/form-data">
						<!-- text input -->
                        ...
                        <div class="form-group" id="option_fitting_div">
						  ...
						  <input type="text" class="form-control" id="meta_value" name="meta_value" placeholder="Enter Option Meta Name" value="">
						...
						<div class="form-group" id="option_fitting_div">
						  ...
						  <input type="text" class="form-control" id="meta_material" name="meta_material" placeholder="Enter Option Meta Material" value="">
						 ...
						 <div class="form-group" id="option_fitting_div">
						  ...
						  <input type="text" class="form-control" id="meta_style" name="meta_style" placeholder="Enter Option Option Meta Style" value="">
						 ...
						 <div class="form-group" id="option_fitting_div">
						  ...
						  <input type="text" class="form-control" id="meta_color" name="meta_color" placeholder="Enter Option Meta Color" value="">
						...
						<div class="form-group" id="option_fitting_div">
						  ...
						  <input type="text" class="form-control" id="meta_finish" name="meta_finish" placeholder="Enter Option Meta Finish" value="">
						...
						<div class="form-group" id="option_fitting_div">
						  ...
						  <input type="text" class="form-control" id="meta_height" name="meta_height" placeholder="Enter Option Meta height" value="">
						...
						<div class="form-group" id="option_fitting_div">
						  ...
						  <input type="text" class="form-control" id="meta_width" name="meta_width" placeholder="Enter Option Meta Width" value="">
						...
						<div class="form-group" id="option_fitting_div">
						  ...
						  <input type="text" class="form-control" id="meta_price" name="meta_price" placeholder="Enter Option Meta Price" value="">
