...
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
	 ...
	 <script>
...

		{
			...
			var resort_ref_id 		= jQuery(resort).find('#resort_ref_id').val();
        ...
        <div class="col-md-6 col-md-offset-3 animated-panel zoomIn" style="animation-delay: 0.1s;">
            <div class="hpanel hblue">
                <div class="panel-body">
                    ...
                    ?>
                    <br/>
                    <form role="form" method="post" action="<?php echo base_url().'Resort/addResort/';?>" onsubmit="return Checkingform(this);" enctype="multipart/form-data">
						...
						<div class="form-group">
						  ...
						  <input type="text" class="form-control" id="resort_name" name="resort_name" placeholder="Put resort name">
						</div>
						<div class="form-group">
							<label for="catImage">Resort Description</label>
							<textarea class="form-control" id="resort_location" name="resort_location" rows="3" placeholder="Put resort description"></textarea>
						</div>
						<div class="form-group">
						  <label>Resort Email</label>
						  <input type="text" class="form-control" id="resort_email" name="resort_email" placeholder="Put resort email id.">
						</div>
						<div class="form-group">
						  <label>Resort Contact no.</label>
						  <input type="text" class="form-control" id="resort_mobile" name="resort_mobile" placeholder="Put resort contact no.">
						</div>
						
						<div class="form-group">
						  <label>Resort Contact Person</label>
						  <input type="text" class="form-control" id="resort_contact_person" name="resort_contact_person" placeholder="Put resort contact person name">
						</div>
						...
						<div class="form-group">
						  ...
						  <input type="radio" name="resort_ref_id" id="resort_ref_id" value="Y" checked>Yes
						  <input type="radio" name="resort_ref_id" id="resort_ref_id" value="N">No
